...
load("Data_files/data_day7142128_hour13and14_with_no_consecutive_zeros.RData")
...
save(data_on_graph, file = "Data_files/data_day7142128_hour13and14_with_no_consecutive_zeros_graphsubset_graph_processed.RData")

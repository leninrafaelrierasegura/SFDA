...
```
|..                                          |   5% [xaringanExtra-clipboard]

processing file: Highways4.Rmd
  |..............................              |  67% [unnamed-chunk-27]       

	*** warning *** max_correction = 25.01 >= 25.00, 'vb.correction' is aborted
	...
	*** warning *** max_correction = 25.00 >= 25.00, 'vb.correction' is aborted
	*** You can change the emergency value (current value=25.00) by 
	*** 	'control.inla=list(control.vb=list(emergency=...))'
  ...
  |.....................................       |  84% [unnamed-chunk-34]       
	...
	GitId: b51fb385728e90bce98ca92b1d8762a2d13f655c - Sat May 18 13:21:08 2024 +0300
	Error:12 Reason: The Newton-Raphson optimizer did not converge
	Message: Condition `lambda < 1.0 / lambda_lim' is not TRUE
	Line:1025 Function: GMRFLib_init_GMRF_approximation_store__intern

Segmentation fault
Killed
                                                                                                                    
/usr/lib/rstudio/resources/app/bin/quarto/bin/tools/x86_64/pandoc +RTS -K512m -RTS Highways4.knit.md --to html4 --from markdown+autolink_bare_uris+tex_math_single_backslash --output Highways4.html --lua-filter /home/rierasl/R/x86_64-pc-linux-gnu-library/4.4/rmarkdown/rmarkdown/lua/pagebreak.lua --lua-filter /home/rierasl/R/x86_64-pc-linux-gnu-library/4.4/rmarkdown/rmarkdown/lua/latex-div.lua --embed-resources --standalone --variable bs3=TRUE --section-divs --table-of-contents --toc-depth 3 --variable toc_float=1 --variable toc_selectors=h1,h2,h3 --variable toc_collapsed=1 --variable toc_smooth_scroll=1 --variable toc_print=1 --template /home/rierasl/R/x86_64-pc-linux-gnu-library/4.4/rmarkdown/rmd/h/default.html --highlight-style pygments --number-sections --variable theme=flatly --mathjax --variable 'mathjax-url=https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js' --include-in-header /tmp/RtmpQjnBgO/rmarkdown-str320ac343c247f6.html --variable code_folding=show --variable code_menu=1 
output file: Highways4.knit.md


Output created: Highways4.html
```

...
# Plot MSE
plot(distance, mse.statnu0.5, main = "MSE", ylim = c(min(mse.nonstatnu0.5, mse.statnu0.5, mse.nonstatnu1.5, mse.statnu1.5, mse.nonstatnuest, mse.statnuest), max(mse.nonstatnu0.5, mse.statnu0.5, mse.nonstatnu1.5, mse.statnu1.5, mse.nonstatnuest, mse.statnuest)),
     type = "l", ylab = "MSE", xlab = "distance in km", col = "red", lty = 2)
lines(distance, mse.nonstatnu0.5, col = "blue", lty = 3)

lines(distance, mse.statnu1.5, col = "black", lty = 3)
lines(distance, mse.nonstatnu1.5, col = "green", lty = 3)

lines(distance, mse.statnuest, col = "skyblue", lty = 3)
lines(distance, mse.nonstatnuest, col = "violet", lty = 3)

legend("bottomright", legend = c("Statnu0.5", "Nonstatnu0.5", "Statnu1.5", "Nonstatnu1.5", "Statnuest", "Nonstatnuest"), col = c("red", "blue", "black", "green", "skyblue", "violet"), lty = 1)

# Plot log-score
plot(distance, -ls.statnu0.5, main = "log-score", ylim = c(min(-ls.nonstatnu0.5, -ls.statnu0.5, -ls.nonstatnu1.5, -ls.statnu1.5, -ls.nonstatnuest, -ls.statnuest), max(-ls.nonstatnu0.5, -ls.statnu0.5, -ls.nonstatnu1.5, -ls.statnu1.5, -ls.nonstatnuest, -ls.statnuest)),
     type = "l", ylab = "log-score", xlab = "distance in km", col = "red", lty = 2)
lines(distance, -ls.nonstatnu0.5, col = "blue", lty = 3)

lines(distance, -ls.statnu1.5, col = "black", lty = 3)
lines(distance, -ls.nonstatnu1.5, col = "green", lty = 3)

lines(distance, -ls.statnuest, col = "skyblue", lty = 3)
lines(distance, -ls.nonstatnuest, col = "violet", lty = 3)

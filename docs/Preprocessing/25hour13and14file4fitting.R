...
sink("~/Desktop/Spring 2024/Model_runs/hour13and14run1.txt")
...
source("Preprocessing/25hour13and14file3covariatesonmesh.R")
...
# loading the data
load("Data_files/data_on_graph_with_covariates_no_consecutive_zerosgraphsubset_hour13and14.RData")
load("Graph_objects/graph_construction_21_03_2024alltomtomwhichlonglatsf.RData")
load("Data_files/data_on_mesh_with_covariates_graphsubset_hour13and14.RData")
...
predicted.values.stat = predict(rspde_model_nonstatWM, 
                                cmp_nonstatWM, 
                                rspde_fit_nonstat_WM, 
                                newdata = prediction.data, 
                                formula = ~ Intercept +
...
save.image("~/Desktop/Spring 2024/Model_runs/hour13and14run1.RData")

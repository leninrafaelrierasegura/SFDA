...
load(here("Data_files/data_day7142128_hour8_with_no_consecutive_zeros_19MAY24_FRC0134_graph_processed.RData"))
...
save(distmatrixlist, file = here("Models_output/distmatrix_day7142128_hour8.RData"))
...
```{r}
load(here("Models_output/distmatrix_day7142128_hour8.RData"))
...
save(GROUPS, file = here("Models_output/GROUPS_day7142128_hour8.RData"))
```
--- 

...
```{r, fig.height = 8, error = TRUE}
start_time.some <- Sys.time()
...
legend("bottomright", legend = c("Stationary", "Non-stationary"), col = c("black", "blue"), lty = 1)
end_time.some <- Sys.time()
execution_time.some <- end_time.some - start_time.some
print(execution_time.some)
```
...
end_time.all <- Sys.time()
execution_time.all <- end_time.all - start_time.all
print(execution_time.all)
```

...
mesh_points = sf_graph$mesh$VtE

dim(mesh_points)

# getting the edge_number and distance_on_edge columns from data
data_on_graph_red = data.frame(edge_number = mesh_points[,1], 
                               distance_on_edge = mesh_points[, 2])
...
cov_number_bus = rep(0, nrow(data_on_graph_red))
...
cov_bus_normalized = rep(0, nrow(data_on_graph_red))
cov_bus_no_normalized = rep(0, nrow(data_on_graph_red))
...
final1 = data_on_graph_red %>% mutate(cov_bus_normalized = cov_bus_normalized, cov_bus_no_normalized = cov_bus_no_normalized, cov_number_bus = cov_number_bus)
...
final2 = data_on_graph_red %>% mutate(cov_signals_normalized = cov_bus_normalized, cov_signals_no_normalized = cov_bus_no_normalized, cov_number_signals = cov_number_bus)
...
final3 = data_on_graph_red %>% mutate(cov_stop_normalized = cov_bus_normalized, cov_stop_no_normalized = cov_bus_no_normalized, cov_number_stop = cov_number_bus)
...
final4 = data_on_graph_red %>% mutate(cov_crossing_normalized = cov_bus_normalized, cov_crossing_no_normalized = cov_bus_no_normalized, cov_number_crossing = cov_number_bus)




data_on_graph_mesh_with_bus_signals_stop_cov = data_on_graph_red %>% mutate(cov_bus_normalized = final1$cov_bus_normalized, 
...
save(data_on_graph_mesh_with_bus_signals_stop_cov, file = "Data_files/data_on_graph_mesh_with_bus_signals_stop_and_numbers_covariates.RData")

...
data_rspde_bru_s_WM1 <- graph_data_rspde(rspde_model_statWM1, loc_name = "loc")
...
cmp_statWM1 = speed ~ -1 +
  ...
  stop +
  crossing +
  field(loc, model = rspde_model_statWM1)
...
data_rspde_bru_s_WM2 <- graph_data_rspde(rspde_model_statWM2, loc_name = "loc")
...
cmp_statWM2 = speed ~ -1 +
  ...
  stop +
  crossing +
  field(loc, model = rspde_model_statWM2)
...
save.image("stationary_gaussian.RData")
